...
derivatives used by every manifest target. `scripts/check-icons.mjs` freezes the
source, dimensions and reviewed output checksums so a placeholder or accidental
asset change cannot silently ship.
